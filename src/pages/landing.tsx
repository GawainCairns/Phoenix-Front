        ...
        <main className="flex px-4 py-20">
          <div>
            ...
            <div className="flex flex-wrap gap-2 space-x-4">
              ...
              <Link to="/surveys/view/1" className="px-4 py-2 text-white rounded bg-cyan-500">View Survey</Link>
              ...
              <Link to="/surveys/mine" className="px-4 py-2 text-white bg-blue-700 rounded">My Surveys</Link>
              <Link to="/surveys/responselist/1" className="px-4 py-2 text-white bg-green-700 rounded">Response List</Link>
            </div>
          </div>
        </main>
      </div>
